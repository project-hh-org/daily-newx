...
const styles = StyleSheet.create({
  ...
  chip: { paddingHorizontal: 12, paddingVertical: 7, borderRadius: 999, borderWidth: 1, cursor: "pointer" },
  ...
  feed: { marginTop: 4 },
  update: { borderBottomWidth: 1, borderBottomColor: colors.rule, paddingVertical: 18, cursor: "pointer" },
  ...
  resLink: { fontFamily: fonts.sans, fontSize: 13, fontWeight: "600", color: colors.spot, cursor: "pointer" },
});
